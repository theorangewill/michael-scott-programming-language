...
private:
  ...
  ExpressionNode* expressionprimary();
  ExpressionNode* expressionPrecedence(int precedence, ExpressionNode* LHS);
  Number* number();
  LogicExpression* logicexpression();
  Logic* logic();
  LogicExpressionNode* logicprimary();
...
ExpressionNode* Parser::expressionPrecedence(int precedence,
                                      ExpressionNode* LHS) {
  while (true) {
    ...
    advance(); 
    ExpressionNode* RHS = expressionprimary();
...
ExpressionNode* Parser::expressionprimary()
{
...
{
  ExpressionNode* LHS = expressionprimary();
  advance();
...
LogicExpressionNode* Parser::logicprimary()
{
  if(lookahead.type == Token::tok_variable
    || lookahead.type == Token::tok_number
